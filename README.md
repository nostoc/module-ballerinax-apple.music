...
[Apple Music](https://music.apple.com/) is Apple's music streaming service that provides access to millions of songs, curated playlists, and personalized recommendations, allowing users to discover, stream, and organize their music library across all their devices.
...
5. Download the private key file (.p8) and note the Key ID displayed on the confirmation page, as you'll need both for authentication.
...
1. [Music recommendation profiling](https://github.com/ballerina-platform/module-ballerinax-apple.music/tree/main/examples/music-recommendation-profiling) - Demonstrates how to create user music profiles for personalized recommendations using the Apple Music connector.
2. [Music library curation](https://github.com/ballerina-platform/module-ballerinax-apple.music/tree/main/examples/music-library-curation) - Illustrates organizing and managing music collections within a user's library.

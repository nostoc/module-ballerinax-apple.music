...
[Apple Music](https://www.apple.com/apple-music/) is a music streaming service that offers users access to millions of songs, curated playlists, and personalized recommendations, along with exclusive content and radio shows.
...
2. Ensure you have an active Apple Developer Program membership ($99/year), as the Apple Music API requires enrollment in the Apple Developer Program to generate the necessary certificates and tokens.
...
4. Click Continue, then Register to create your key and download the .p8 file containing your private key.

5. Note your Key ID, Team ID, and use these along with the private key to generate JWT tokens for API authentication.
...
1. [Music discovery workflow](https://github.com/ballerina-platform/module-ballerinax-apple.music/tree/main/examples/music-discovery-workflow) - Demonstrates how to implement music discovery and recommendation features using the Apple Music API.
2. [Album analytics workflow](https://github.com/ballerina-platform/module-ballerinax-apple.music/tree/main/examples/album-analytics-workflow) - Illustrates how to analyze album data and generate insights from Apple Music catalog information.

...
2. Ensure you have a paid Apple Developer Program membership ($99/year), as the Apple Music API requires an active developer program enrollment to generate API keys.
...
5. Download the .p8 key file and note your Key ID and Team ID, as you'll need all three components for authentication.
...
2. [Music artist discovery](https://github.com/ballerina-platform/module-ballerinax-apple.music/tree/main/examples/music-artist-discovery) - Illustrates discovering and retrieving information about music artists.

...
To use the Apple Music connector, you must have access to the Apple Music API through an [Apple Developer account](https://developer.apple.com/) and obtain API credentials including a private key and other required tokens. If you do not have an Apple Developer account, you can sign up for one [here](https://developer.apple.com/programs/).
...
2. Ensure you have a paid Apple Developer Program membership ($99/year), as access to the Apple Music API requires an active paid membership.
...
5. Download the private key file (.p8) and note your Key ID and Team ID, as you'll need all three components to authenticate with the Apple Music API.
...
1. [Music library discovery](https://github.com/ballerina-platform/module-ballerinax-apple.music/tree/main/examples/music-library-discovery) - Demonstrates how to discover and retrieve music from a user's Apple Music library.
2. [Music discovery recommendations](https://github.com/ballerina-platform/module-ballerinax-apple.music/tree/main/examples/music-discovery-recommendations) - Illustrates how to fetch personalized music recommendations and discovery features.

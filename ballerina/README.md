...
6. Also note your Team ID, which can be found in the top-right corner of the Apple Developer portal or in your membership details.
...
1. [Music recommendation profiling](https://github.com/ballerina-platform/module-ballerinax-apple.music/tree/main/examples/music-recommendation-profiling) - Demonstrates how to create personalized music recommendation profiles using Ballerina connector for Apple Music.
2. [Music library curation](https://github.com/ballerina-platform/module-ballerinax-apple.music/tree/main/examples/music-library-curation) - Illustrates organizing and managing music libraries with automated curation features.
...
5. Note your Team ID from your Apple Developer account membership details, as you'll need this along with the Key ID and private key file for authentication.
...
2. [Album discovery workflow](https://github.com/ballerina-platform/module-ballerinax-apple.music/tree/main/examples/album-discovery-workflow) - Illustrates creating workflows for discovering and exploring albums through the Apple Music API.
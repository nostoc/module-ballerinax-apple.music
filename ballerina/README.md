...
[Apple Music](https://www.apple.com/apple-music/) is a streaming service that offers users access to over 100 million songs, along with curated playlists, radio shows, and exclusive content from artists worldwide.
...
5. Download the private key file (.p8) and note the Key ID displayed on the confirmation page, as you'll need both for API authentication.
...
public function main() returns error? {
    check appleMusicClient->/me/library.post({
        ids: ["1234567890:songs", "0987654321:albums"]
    });
}
```
...
1. [Music discovery workflow](https://github.com/ballerina-platform/module-ballerinax-apple.music/tree/main/examples/music-discovery-workflow) - Demonstrates how to implement music discovery features using Ballerina connector for Apple Music.
2. [Album analytics workflow](https://github.com/ballerina-platform/module-ballerinax-apple.music/tree/main/examples/album-analytics-workflow) - Illustrates analyzing album data and metrics through the Apple Music API.
...
# Response object containing error information when request processing fails
...
public type SongsRelationships record {
    ...
    # The composers associated with this song
    record {} composers?;
    # The library version of this song, if it exists in the user's library
    record {} library?;
    # The response to an artists request
    ArtistsResponse artists?;
    # The genres associated with this song
    record {} genres?;
    # The music videos associated with this song
    @jsondata:Name {value: "music-videos"}
    record {} musicVideos?;
    # The Apple Music station based on this song
    record {} station?;
};
...
public type ArtistsRelationships record {
    # The response to an albums request
    AlbumsResponse albums?;
    # The genres associated with this artist
    record {} genres?;
    # The music videos created by this artist
    @jsondata:Name {value: "music-videos"}
    record {} musicVideos?;
...
public type MusicVideosAttributes record {
    ...
    string name;
    # An array of preview clips available for the music video
    Preview[] previews;
    # The artist's name
    string artistName;
    # The Recording Industry Association of America (RIAA) rating of the content. The possible values for this rating are clean and explicit. No value means no rating
...
# Response containing library artists from user's personal collection

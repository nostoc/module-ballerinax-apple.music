...
public type SongsRelationships record {
    ...
    record {} composers?;
    # The library version of the song, if available
    record {} library?;
    ...
    record {} musicVideos?;
    # The Apple Music station related to the song
    record {} station?;
};
...
public type ArtistsRelationships record {
    ...
    record {} genres?;
    # The music videos created by the artist
    @jsondata:Name {value: "music-videos"}
    record {} musicVideos?;
...
public type LibraryArtistsRelationships record {
    # Response containing library albums from the user's personal music collection

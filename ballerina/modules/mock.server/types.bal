...
public type SongsRelationships record {
    ...
    record {} composers?;
    # Library information for the song
    record {} library?;
...
public type LibraryArtistsRelationships record {
    # Response containing library albums with pagination support
...
# Response containing artists from the user's personal library

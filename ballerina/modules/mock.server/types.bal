...
public type SongsAttributes record {
    ...
    string name;
    # Collection of audio preview clips for the song
    Preview[] previews;
    # The artist's name
    string artistName;
...
# Response schema containing error information when API requests fail
...
public type SongsRelationships record {
    ...
    record {} composers?;
    # Library version of the song if available
    record {} library?;
...
public type ArtistsRelationships record {
    ...
    record {} genres?;
    # Music videos created by the artist
    @jsondata:Name {value: "music-videos"}
    record {} musicVideos?;
...
public type LibraryArtistsRelationships record {
    ...
    # Apple Music Catalog information for the library artist
    record {} catalog?;
};
...
public type MusicVideosAttributes record {
    ...
    string name;
    # Collection of preview clips available for the music video
    Preview[] previews;
    # The artist's name
    string artistName;
    # The Recording Industry Association of America (RIAA) rating of the content. The possible values for this rating are clean and explicit. No value means no rating

...
public type SongsAttributes record {
    ...
    string name;
    # Available audio preview clips for the song
    Preview[] previews;
    # The artist's name
    string artistName;
...
# Collection of errors that occurred while processing the request
...
public type SongsRelationships record {
    ...
    # Composers who wrote this song
    record {} composers?;
    # Library version of this song if it exists
    record {} library?;
    # The response to an artists request
    ArtistsResponse artists?;
    # Genres associated with this song
    record {} genres?;
    # Music videos associated with this song
...
public type LibraryArtistsRelationships record {
    # Response containing library albums from the user's iCloud Music Library
    LibraryAlbumsResponse albums?;
    # Apple Music Catalog equivalent of the library artist
    record {} catalog?;
};
...
# Response containing library artists with pagination support

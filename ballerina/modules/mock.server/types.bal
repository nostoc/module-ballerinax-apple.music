...
public type SongsAttributes record {
    ...
    EditorialNotesType editorialNotes?;
};
...
# Response object containing error details when request processing fails
...
public type ErrorsResponseInternalServerErrorType record {|
...
public type ErrorsResponseUnauthorizedType record {|
    *http:Unauthorized;
    ErrorsResponse body;
|};

# The response to a songs request
public type SongsResponseType record {
...
public type ArtistsRelationships record {
    ...
    record {} genres?;
    # The music videos associated with the artist
    @jsondata:Name {value: "music-videos"}
    record {} musicVideos?;
...
# An object that represents artwork
public type ArtworkType record {
...
# The response to an artists request
public type ArtistsResponseType record {
    # A relative cursor to fetch the next paginated collection of resources, if more exist
    string next?;
...
# The response to an albums request
public type AlbumsResponseType record {
    # A relative cursor to fetch the next paginated collection of resources, if more exist
    string next?;
...
public type LibrarySongsResponseType record {
    # A relative cursor to fetch the next paginated collection of resources, if more exist
    string next?;
...
public type LibraryArtistsRelationships record {
    # Response containing library albums with pagination and metadata
    LibraryAlbumsResponseType albums?;
    # Apple Music catalog reference for the library artist
    record {} catalog?;
};

# An object that represents a preview for resources
public type PreviewType record {
    # An object that represents artwork
    ArtworkType artwork?;
...
public type MusicVideosAttributes record {
    ...
    string name;
    # An array of preview content for the music video
    PreviewType[] previews;
    # The artist's name
    string artistName;
    # The Recording Industry Association of America (RIAA) rating of the content. The possible values for this rating are clean and explicit. No value means no rating
...
public type MusicVideosResponseType record {
...
# Response containing library albums with pagination and metadata
public type LibraryAlbumsResponseType record {
    # A relative cursor to fetch the next paginated collection of resources, if more exist
    string next?;
...
# Response containing artists from user's personal iCloud Music Library
public type LibraryArtistsResponseType record {
    # A relative cursor to fetch the next paginated collection of resources, if more exist
    string next?;
...
public type ErrorsResponseForbiddenType record {|
    *http:Forbidden;
    ErrorsResponse body;
|};

# An object that represents a notes attribute
public type EditorialNotesType record {
...
public type Artwork ArtworkType;
public type Preview PreviewType;
public type EditorialNotes EditorialNotesType;
public type SongsResponse SongsResponseType;
public type SearchResponse SearchResponseType;
public type ArtistsResponse ArtistsResponseType;
public type AlbumsResponse AlbumsResponseType;
public type LibrarySongsResponse LibrarySongsResponseType;
public type MusicVideosResponse MusicVideosResponseType;
public type LibraryAlbumsResponse LibraryAlbumsResponseType;
public type LibraryArtistsResponse LibraryArtistsResponseType;
public type ErrorsResponseInternalServerError ErrorsResponseInternalServerErrorType;
public type ErrorsResponseUnauthorized ErrorsResponseUnauthorizedType;
public type ErrorsResponseForbidden ErrorsResponseForbiddenType;
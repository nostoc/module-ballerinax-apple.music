...
public type SongsAttributes record {
    ...
    string name;
    # Audio preview clips for the song
    Preview[] previews;
    # The artist's name
    string artistName;
...
public type SongsRelationships record {
    ...
    record {} composers?;
    # Library version of the song if it exists in user's library
    record {} library?;
...
public type LibrarySongsRelationships record {
    ...
    # The response to an artists request
    ArtistsResponse artists?;
    # Corresponding catalog version of the library song
    record {} catalog?;
};
...
public type LibraryArtistsRelationships record {
    ...
    # Catalog information for the library artist
    record {} catalog?;
};

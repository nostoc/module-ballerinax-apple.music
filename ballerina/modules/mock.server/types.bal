...
public type ArtworkData record {
...
public type EditorialNotesData record {
...
public type PreviewData record {
    # An object that represents artwork
    ArtworkData artwork?;
...
public type SongsAttributes record {
    ...
    string name;
    # Array of audio preview clips for the song
    ...
    # An object that represents a notes attribute
    EditorialNotesData editorialNotes?;
};
...
public type ErrorsResponseInternalServerErrorData record {|
...
public type ErrorsResponseUnauthorizedData record {|
    *http:Unauthorized;
    ErrorsResponse body;
|};

# The response to a songs request
public type SongsResponseData record {
...
public type ArtistsResponseData record {
    # A relative cursor to fetch the next paginated collection of resources, if more exist
    string next?;
...
public type AlbumsResponseData record {
    # A relative cursor to fetch the next paginated collection of resources, if more exist
    string next?;
...
public type SongsRelationships record {
    # The response to an albums request
    AlbumsResponseData albums?;
    # Composers who created this song
    record {} composers?;
    # User's personal library version of this song
    record {} library?;
    # The response to an artists request
    ArtistsResponseData artists?;
    # Musical genres associated with this song
    record {} genres?;
    # Music videos related to this song
    @jsondata:Name {value: "music-videos"}
    record {} musicVideos?;
    # Apple Music station based on this song
    record {} station?;
};

# The response to a search request
public type SearchResponseData record {
...
public type ArtistsRelationships record {
    ...
    record {} genres?;
    # Music videos created by this artist
    @jsondata:Name {value: "music-videos"}
    record {} musicVideos?;
...
public type LibrarySongsResponseData record {
    # A relative cursor to fetch the next paginated collection of resources, if more exist
    string next?;
...
public type LibraryArtistsRelationships record {
    # Response containing albums from the user's personal iCloud Music Library
    LibraryAlbumsResponseData albums?;
    # Apple Music Catalog representation of the library artist
    record {} catalog?;
};
...
public type MusicVideosResponseData record {
...
# Response containing albums from the user's personal iCloud Music Library
public type LibraryAlbumsResponseData record {
    # A relative cursor to fetch the next paginated collection of resources, if more exist
    string next?;
...
public type LibraryArtistsResponseData record {
    # A relative cursor to fetch the next paginated collection of resources, if more exist
    string next?;
...
public type ErrorsResponseForbiddenData record {|
    *http:Forbidden;
    ErrorsResponse body;
|};
